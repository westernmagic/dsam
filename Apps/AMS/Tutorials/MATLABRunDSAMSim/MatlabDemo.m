...
function matlabDemo (simFilePath, simFileName, outputFileName)
...
pars=[ ...
        ' LOW_HARMONIC.Stim_Harmonic.stim '	num2str(lowestHarmonicNumber) ...
        ' HIGH_HARMONIC.Stim_Harmonic.stim '  num2str(highestHarmonicNumber) ...
    ];
