...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "$(DSAMDIR)\include" /I "$(DSAMDIR)" /I "$(WXWIN)\include" /I "$(WXWIN)\lib\mswdll" /I "$(WXWIN)\contrib\include" /D "NDEBUG" /D "WIN32" /D "_MBCS" /D "_LIB" /D HAVE_CONFIG_H=1 /D LIBRARY_COMPILE=1 /D WXUSINGDLL=1 /YX /FD /c
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "$(DSAMDIR)\include" /I "$(DSAMDIR)" /I "$(WXWIN)\include" /I "$(WXWIN)\lib\mswdll" /I "$(WXWIN)\contrib\include" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "WIN32" /D HAVE_CONFIG_H=1 /D LIBRARY_COMPILE=1 /YX /FD /GZ /c
