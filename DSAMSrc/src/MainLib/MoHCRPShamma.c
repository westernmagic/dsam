...
Init_IHCRP_Shamma(ParameterSpecifier parSpec)
{
	...
	shammaPtr->endocochlearPotEtFlag = FALSE;
	shammaPtr->reversalPotEkFlag = FALSE;
	shammaPtr->reversalPotCorrectionFlag = FALSE;
	shammaPtr->totalCapacitanceCFlag = FALSE;
	shammaPtr->restingConductanceG0Flag = FALSE;
	shammaPtr->kConductanceGkFlag = FALSE;
	shammaPtr->maxMConductanceGmaxFlag = FALSE;
	shammaPtr->ciliaCouplingGainFlag = FALSE;
	shammaPtr->ciliaTimeConstTcFlag = FALSE;
	shammaPtr->betaFlag = FALSE;
	shammaPtr->gammaFlag = FALSE;
	shammaPtr->referencePotFlag = FALSE;
	shammaPtr->endocochlearPot_Et = 0.0;
	shammaPtr->reversalPot_Ek = 0.0;
	shammaPtr->reversalPotCorrection = 0.0;
	shammaPtr->totalCapacitance_C = 0.0;
	shammaPtr->restingConductance_G0 = 0.0;
	shammaPtr->kConductance_Gk = 0.0;
	shammaPtr->maxMConductance_Gmax = 0.0;
	shammaPtr->beta = 0.0;
	shammaPtr->gamma = 0.0;
	shammaPtr->ciliaCouplingGain_C = 0.0;
	shammaPtr->ciliaTimeConst_tc = 0.0;
