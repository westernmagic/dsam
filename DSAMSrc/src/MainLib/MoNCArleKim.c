...
Init_Neuron_ArleKim(ParameterSpecifier parSpec)
{
	...
	arleKimPtr->membraneTConstFlag = FALSE;
	arleKimPtr->thresholdTConstFlag = FALSE;
	arleKimPtr->accomConstFlag = FALSE;
	arleKimPtr->delayedRectKCondFlag = FALSE;
	arleKimPtr->restingThresholdFlag = FALSE;
	arleKimPtr->actionPotentialFlag = FALSE;
	arleKimPtr->kDecayTConstFlag = FALSE;
	arleKimPtr->nonLinearVConstFlag = FALSE;
	arleKimPtr->kReversalPotenFlag = FALSE;
	arleKimPtr->bReversalPotenFlag = FALSE;
	arleKimPtr->kRestingCondFlag = FALSE;
	arleKimPtr->bRestingCondFlag = FALSE;
	arleKimPtr->membraneTConst_Tm = 0.0;
	arleKimPtr->kDecayTConst_TGk = 0.0;
	arleKimPtr->thresholdTConst_TTh = 0.0;
	arleKimPtr->accomConst_c = 0.0;
	arleKimPtr->delayedRectKCond_b = 0.0;
	arleKimPtr->restingThreshold_Th0 = 0.0;
	arleKimPtr->actionPotential = 0.0;
	arleKimPtr->nonLinearVConst_Vnl = 0.0;
	arleKimPtr->kReversalPoten_Ek = 0.0;
	arleKimPtr->bReversalPoten_Eb = 0.0;
	arleKimPtr->kRestingCond_gk = 0.0;
...
double
GetPotentialResponse_Neuron_ArleKim(double potential)
{
