...
Init_Harmonic(ParameterSpecifier parSpec)
{
	...
	harmonicPtr->lowestHarmonicFlag = FALSE;
	harmonicPtr->highestHarmonicFlag = FALSE;
	harmonicPtr->mistunedHarmonicFlag = FALSE;
	harmonicPtr->phaseModeFlag = FALSE;
	harmonicPtr->phaseVariableFlag = FALSE;
	harmonicPtr->mistuningFactorFlag = FALSE;
	harmonicPtr->frequencyFlag = FALSE;
	harmonicPtr->intensityFlag = FALSE;
	harmonicPtr->durationFlag = FALSE;
	harmonicPtr->dtFlag = FALSE;
	harmonicPtr->modulationFrequencyFlag = FALSE;
	harmonicPtr->modulationPhaseFlag = FALSE;
	harmonicPtr->modulationDepthFlag = FALSE;
	harmonicPtr->orderFlag = FALSE;
	harmonicPtr->lowerCutOffFreqFlag = FALSE;
	harmonicPtr->upperCutOffFreqFlag = FALSE;
	harmonicPtr->intensityFlag = FALSE;
	harmonicPtr->lowestHarmonic = 0;
	harmonicPtr->highestHarmonic = 0;
	harmonicPtr->mistunedHarmonic = 0;
	harmonicPtr->phaseMode = 0;
	harmonicPtr->mistuningFactor = 0.0;
	harmonicPtr->phaseVariable = 0.0;
	harmonicPtr->frequency = 0.0;
	harmonicPtr->intensity = 0.0;
	harmonicPtr->duration = 0.0;
	harmonicPtr->dt = 0.0;
	harmonicPtr->modulationFrequency = 0.0;
	harmonicPtr->modulationPhase = 0.0;
	harmonicPtr->modulationDepth = 0.0;
	harmonicPtr->order = 0;
	harmonicPtr->lowerCutOffFreq = 0.0;
	harmonicPtr->upperCutOffFreq = 0.0;
